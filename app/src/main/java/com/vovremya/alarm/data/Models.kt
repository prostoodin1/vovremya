...
data class AppSettings(
    ...
    val reminderAutoDismissEnabled: Boolean = false,
    val reminderAutoDismissMinutes: Int = 5,
    ...
    val importantCalendarIds: Set<Long> = emptySet(),
    ...
    val swipePreviewEnabled: Boolean = false,
